...
function generateWalkForwardWindows(input) {
  ...
  if (stepSize !== trainWindowSize + embargoTradingDayCount + oosWindowSize) {
  ...
  if (n < trainWindowSize + embargoTradingDayCount + oosWindowSize) {
  ...
  const sliceKinds = ["train", "embargo", "oos"];
  for (let i = 0; i < windows.length; i += 1) {
