...
test("GATE5H-P50 허용 파일 외 변경 없음", () => {
  ...
  const allowed = new Set([
    ...
    "lib/paper/paper-risk-engine.js",
    "test/paper-account-state.test.js",
    "test/paper-ledger-stepper.test.js",
    "test/paper-execution-adapter.test.js",
    "test/paper-risk-engine.test.js",
    "scripts/gate.js",
    "test/gate-runner-fs.test.js",
    "test/gate-runner-git.test.js",
    "test/gate-runner-helpers.test.js",
    "test/gate-runner-p50.test.js",
    "test/gate-runner-report.test.js",
    "test/gate-runner-safety.test.js",
    "test/gate-runner-schema.test.js",
    "test/gate-runner-testrunner.test.js",
    "tools/gate-runner/commands.js",
    "tools/gate-runner/eligibility.js",
    "tools/gate-runner/errors.js",
    "tools/gate-runner/fs-safe.js",
    "tools/gate-runner/git-inspector.js",
    "tools/gate-runner/index.js",
    "tools/gate-runner/json-safe.js",
    "tools/gate-runner/p50.js",
    "tools/gate-runner/policy.js",
    "tools/gate-runner/redaction.js",
    "tools/gate-runner/report.js",
    ...
    "lib/paper/paper-session-manager.js",
